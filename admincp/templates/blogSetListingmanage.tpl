<div class="rightContHeading Heading">{$LANG.admin_blog_set_list} <a class="backButt pull-right" href="blogSetListingManage.php"><i class="fa fa-backward"></i> {$LANG.admin_back}</a></div>
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			<tr class="listHeader leftNavblueBg">
				...
				<td width="15%" align="center" class="listHeaderCont">{$LANG.admin_comment_default}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_notifyme_email}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_automaticallyclose}</td>
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="center" class="listCont">{$domainpage[page].comment_default}</td>
                <td align="center" class="listCont">{$domainpage[page].notifyme_email}</td>
                <td align="center" class="listCont">{$domainpage[page].automaticallyclose}</td>
