<div class="rightContHeading Heading">{$LANG.admin_domain_image_management} <a class="backButt pull-right" href="domainImageManage.php"><i class="fa fa-backward"></i> {$LANG.admin_back}</a></div>
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="left" class="listCont">{$objAdminMgmt->getDomain($domain_image[image].domain_id)}</td>
