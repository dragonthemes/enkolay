<div class="rightContHeading Heading">{$LANG.admin_domain_page} <a class="backButt pull-right" href="domainPageListManage.php"><i class="fa fa-backward"></i> {$LANG.admin_back}</a></div>
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			<tr class="listHeader leftNavblueBg">
                ...
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_page_seotitle}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_page_metakey}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_page_description}</td>
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="left" class="listCont"><a href="pageListManage.php?page_id={$domainpage[page].page_id}" target="_blank">{$domainpage[page].pagename}</a></td>                
                <td align="center" class="listCont">{$domainpage[page].seo_title}</td>
                <td align="center" class="listCont">{$domainpage[page].meta_key}</td>
                <td align="center" class="listCont">{$domainpage[page].page_desc}</td>
			</tr>
			{sectionelse}
