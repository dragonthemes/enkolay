<div class="rightContHeading Heading">{$LANG.admin_domain_page}</div>
		...
		{if $totalRecords gt 0}
			...
			<span class="processButton" id="searchkey">
				<form name="filterform" method="post" onsubmit="return filterValidation();" class="no-mar pull-left">
					...
					{$LANG.admin_keyword}:
					<input type="text" name="keyword" id="keyword" value="{$smarty.request.keyword}" placeholder="Page Name" class="no-mar">
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="left" class="listCont"><a href="pageListManage.php?page_id={$domainpage[page].page_id}">{$domainpage[page].pagename}</a></td>                
