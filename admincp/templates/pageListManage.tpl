<div class="rightContHeading Heading">{$LANG.admin_page_list}</div>
<div class="ContBody clearfix">
	...
	<div class="pageContTop sky-form form-horizontal skyformbgNon">
		<ul class="page">
			...
			<li class="pages">
				<label class="select">
					<select class="pageSelectbox" onchange="showPerPagefield(this.value,'{$smarty.get.keyword}','{$smarty.get.sortby}','page_id={$smarty.get.page_id}');" >
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			<tr class="listHeader leftNavblueBg">
				...
				<td width="15%" align="center" class="listHeaderCont">{$LANG.admin_domainid}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_pageid}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_textitle}</td>
				<td width="15%" align="center" class="listHeaderCont">{$LANG.admin_textdescription}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_imageselect}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_imagetext}</td>				
			</tr>
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <!--<td align="center" class="listCont">{$domainpage[page].subdomainurl|stripslashes }</td>-->
                <td align="center" class="listCont">{$objAdminMgmt->getDomain($domainpage[page].domain_id)}</td>
                <td align="center" class="listCont">{$objAdminMgmt->getPagename($domainpage[page].page_id)}</td>
                <td align="center" class="listCont">{$domainpage[page].text_title}</td>
                <td align="center" class="listCont">{$domainpage[page].text_description}</td>
                <td align="center" class="listCont"><img src="{$SITE_DOMAIN_IMAGES_URL}/{$objAdminMgmt->getImage($domainpage[page].pagelist)}" width="100" height="100"/>
                </td>                
                <td align="center" class="listCont">{$objAdminMgmt->getImageText($domainpage[page].pagelist)}</td>
			</tr>
			{sectionelse}
