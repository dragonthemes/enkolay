<div class="rightContHeading Heading">{$LANG.admin_post_list}</div>
<div class="ContBody clearfix">
	...
	<div class="pageContTop sky-form form-horizontal skyformbgNon">
		<ul class="page">
			...
			<li class="pages">
				<label class="select">
					<select class="pageSelectbox" onchange="showPerPagefield(this.value,'{$smarty.get.keyword}','{$smarty.get.sortby}','post_id={$samrty.get.post_id}');" >
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			<tr class="listHeader leftNavblueBg">
                ...
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_post_title}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_comments}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_post_drafts}</td>				
			</tr>
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="left" class="listCont">{$objAdminMgmt->getCommonSingleSelection('title',$posttitle,'domain_id',$domainpage[page].domain_id)}</td>
                <td align="left" class="listCont"><a href="commentListManage.php?blog_id={$domainpage[page].blog_id}" target="_blank">Comments</a></td>
                <td align="center" class="listCont">{$domainpage[page].drafts}</td>
			</tr>
			{sectionelse}
