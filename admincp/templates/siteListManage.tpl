<div class="rightContHeading Heading">{$LANG.admin_settings}</div>
	...
	<div class="tableListContainer">
		<table width="100%" border="0" class="tableListContent">
			<tr class="listHeader leftNavblueBg">
				...
				<td width="15%" align="center" class="listHeaderCont">{$LANG.admin_siteaddress}</td>	
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_sitetitle}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_sitedescription}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_site_metakey}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_site_headercode}</td>
				<td width="15%" align="center" class="listHeaderCont">{$LANG.admin_site_footercode}</td>
                <td width="15%" align="center" class="listHeaderCont">{$LANG.admin_site_dateadded}</td					
			</tr>
			...
			<!--	<td align="center" class="listCont"><input type="checkbox" class="case" value="{$domain_image[image].img_id}" onclick="individualSelect();" /></td>-->
                ...
                <td align="center" class="listCont">{$domainpage[page].site_title}</td>
                <td align="center" class="listCont">{$domainpage[page].site_description}</td>
                <td align="center" class="listCont">{$domainpage[page].metakeywords}</td>
                <td align="center" class="listCont">{$domainpage[page].header_code}</td>
                <td align="center" class="listCont">{$domainpage[page].footer_code_code}</td>
