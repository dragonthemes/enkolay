         ...
         if(in_array($ext,$valid_formats))
	         {
	           ...
	           if (move_uploaded_file($_FILES['photos']['tmp_name'][$name], $newname)) 
	           {
			       ...
			       $page_list_id = $_POST['page_list_id'];
				    ...
				    $objThumb->createThumb($newname,$temp_file,$imagWH['width'],$imagWH['height'],''); 
            ...
            echo "<li class='SlideUplWidtPopup'><img src='".$showImageUrl.$image_name."' class='imgList' width='100%' height='150'><a class='galleryimage'  onclick=\"deleteGalImgColumn('".$domain_id."','".$page_id."','".$page_list_id."','".$LastInsertedRow."')\"><img src=\" ".$CFG['site']['base_url']."/images/Close.png\" /></a></li>";
