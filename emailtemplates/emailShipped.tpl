	...
	<div style="padding: 18px;">
		...
		<div style="border: 1px solid #CCCCCC; padding: 2px;">
			...
			<ul style="margin: 0; padding: 15px;">	
				<li style="display: block; line-height: 24px;font: 13px/24px 'Trebuchet MS';">{SHIPPING_COMPANY}</li>
				<li style="display: block; line-height: 24px;font: 13px/24px 'Trebuchet MS';">{SHIPPING_STREET}</li>
				<li style="display: block; line-height: 24px;font: 13px/24px 'Trebuchet MS';">{SHIPPING_POSTAL}</li>
