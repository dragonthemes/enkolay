...
#....................................................................................................  
 ...
 function getColumnTextImages($pageid)    
 {
   ...
   $columnimages = array();
 	...
 	$columnimages    = $this->getMultiValue("image_name,column_text_title,column_text_desc,column_id,status",$CFG['table']['temp_column_text_images']," page_id='".$pageid."' ORDER BY column_id ASC");
...
{
    global $CFG;
    $youtupe  = " SELECT img_id,	page_id ,domain_id ,page_list_id ,imagelib_id ,image_name ,column_text_title ,column_text_desc ,column_id , 	alignment ,	status ,publish_status ,delete_status FROM ".$table_name." WHERE domain_id='".$this->filterInput($domain_id)."' ";
    $sqlres =  $this->ExecuteQuery($youtupe,'select');
    return $sqlres;         
} 
