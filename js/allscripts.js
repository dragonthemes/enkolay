...
$(".editbannerTxt").click(function(){        
        $( "#banner_imageLibrary,#banner_slider_imageLibrary" ).tabs();       
});
$('#photosliderimg').on('change', function(event){ 
    
    $(".curslidimg").parent().remove();
    var input = event.target;
    var reader = new FileReader();
    $("#uploadtype").val("fileupload");
    reader.onload = function(event){
      var dataURL = event.target.result;	
      var elemt     = $("#slidesortableImg li:last").clone();      
      $("#slidesortableImg").append("<li class=\"SlideUplWidtPopup\" > <img width=\"100%\" class='curslidimg' height=\"150\" src=\"\"> </li>");
      $('.curslidimg').attr("src",dataURL);     
...
$(function () {      
    ...
    $(".sortcolumn").sortable({
        ...
        stop: function (event, ui) {
          ...
          var dropColumnId = newList.parent().attr("id");
		  var dropColumnListId = ui.item.attr("id");
		  
          $.post("ajaxFile.php",{"action":"UpdateColumnid_pagelist","columnid":dropColumnId,"pagelist":dropColumnListId},function(data){
	    ...
	    placeholder: 'highlightLineColumn'
    });
    $(".sortcolumn").droppable().sortable({placeholder: 'highlightLineColumn'});
});   
...
$(document).ready(function(){
	...
	/*$('.nivoSliderImg').nivoSlider({
	 ...
	 $(".publishClose").click(function(){
	  ...
	  $("#toolssection li a").click(function() {
		  $("#toolssection li a").removeClass("active");
		  $(this).addClass("active");
		  $(".toolsectioncontent").hide();
		  var activeId = $(this).attr("id");
		  $('#'+activeId+'_content').show();
	  });	
...
$(function(){
	$( "#draggable_content li" ).draggable({ 
		...
		start: function(event,ui) {
			/*$('html, body').animate({
				scrollTop: $("#droppable_content").offset().top-$(".toppanel").height()
			}, 1000);*/
		...
		drag: function(event,ui) {
			...
			/*if(leftvalue == '1'||leftvalue == '2'||leftvalue == '3'||leftvalue == '4'||leftvalue == '5'||leftvalue == '9'||leftvalue == '10'||leftvalue == '11'||leftvalue == '12'||leftvalue == '13'){
				ui.helper.css({"left":event.screenX-dragleft,"top":event.screenY-dragleft});	
			}
			if(leftvalue == '8'){
			  	ui.helper.css({"left":event.screenX-(dragleft1),"top":event.screenY-(dragleft1-35)});
			}	
			if(leftvalue == '7'||leftvalue == '14'||leftvalue == '15'){
				ui.helper.css({"left":event.screenX-dragleft2,"top":event.screenY-(dragleft-35)});	
			}
			if(leftvalue == '6'){
			   	ui.helper.css({"left":event.screenX-(dragleft2+100),"top":event.screenY-(dragleft-60)});
			}*/
		}
	});
...
function changeBackgroundStatus(obj)
{
    ...
    $.post("ajaxFile.php",{"action":"changeBackgroundColoroff","status":status},function(data){        
        location.href=location.href;
    });*/
}
function changeBackgroundStatus_default(val,obj)
{
    /*$(".defaultstatus1").removeClass("active");
    $(obj).addClass("active");
    $.post("ajaxFile.php",{"action":"BackgroundDefault","value":val},function(data){
        location.href=location.href;
    });*/
    $(".backstatus").removeClass("active");
    $(".backstatus[data-val=OFF]").addClass("active");    
