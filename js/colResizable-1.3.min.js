...
(function (a) {
    ...
    var i = a(document),
        ...
        M = "resize",
        N = "table",
        O, P = a("head")[z](x + ".CRZ{table-layout:fixed;}.CRZ td,.CRZ th{padding-" + H + L + "padding-right" + L + "overflow:hidden}.CRC{height:0px;" + I + ":relative;}.CRG{margin-left:-0.5px;" + I + ":absolute;z-index:11000;}.CRG .CRZ{" + I + ":absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:15px;height:100%;top:0px;left:-7.5px;}.CRL{" + I + ":absolute;width:1px}.CRD{ border-left:0px dotted black" + J);
    try {
        O = sessionStorage
    } catch (Q) {}
