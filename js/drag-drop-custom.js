	...
	{		
	  ...
	  while((inputObj = inputObj.offsetParent) != null){
	  	if(inputObj.tagName!='HTML'){
	  		returnValue += inputObj.offsetTop-inputObj.offsetTop;
...
dragDrop.prototype = {
	...
	{
		$(".mainLeftPanelScroll.nano").removeClass("overflow");
		$(".mainLeftPanelScroll .contentNanoScroll").removeClass("overflowxy");
		$(".mainLeftPanelScroll .contentNanoScroll").addClass("width100");
		$(".mainLeftPanelScroll .contentNanoScroll").css("top",'-'+$(".slider").css("top"));
		...
		if(referenceToDragDropObject.dragDropSourcesArray[referenceToDragDropObject.numericIdToBeDragged][1]){
			...
			if(referenceToDragDropObject.numericIdToBeDragged!=5 || referenceToDragDropObject.numericIdToBeDragged!=6 || referenceToDragDropObject.numericIdToBeDragged!=7){
				referenceToDragDropObject.dragObjCloneArray[referenceToDragDropObject.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(referenceToDragDropObject.dragDropSourcesArray[referenceToDragDropObject.numericIdToBeDragged][0]) - 96 + 'px';
			}
			if(referenceToDragDropObject.numericIdToBeDragged==7){
				referenceToDragDropObject.dragObjCloneArray[referenceToDragDropObject.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(referenceToDragDropObject.dragDropSourcesArray[referenceToDragDropObject.numericIdToBeDragged][0]) - 192 + 'px';
			}
			if(referenceToDragDropObject.numericIdToBeDragged==6){
				referenceToDragDropObject.dragObjCloneArray[referenceToDragDropObject.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(referenceToDragDropObject.dragDropSourcesArray[referenceToDragDropObject.numericIdToBeDragged][0]) - 288 + 'px';
			}
			if(referenceToDragDropObject.numericIdToBeDragged==5){
				referenceToDragDropObject.dragObjCloneArray[referenceToDragDropObject.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(referenceToDragDropObject.dragDropSourcesArray[referenceToDragDropObject.numericIdToBeDragged][0]) - 384 + 'px';
			}
		}
		...
		//For To show the Drop Box Separately
		//$("#dropBox").css({"box-shadow":"1px 0px 5px #126BAF"});
		//$("#sortable").css({"box-shadow":"1px 0px 5px #126BAF"});
		$(".sortouterHeight").css("background-repeat","no-repeat");
		$(".sortouterHeight").css("background-size","100% 85%");
		$(".sortouterHeight").css("border-top","4px solid #afddff");
		$(".sortouterHeight").addClass("borderbtm");
		$(".sortouterHeight").css("padding","10px");
		//$(".sortouterHeight").css("z-index","10000");/* drag box highlight */
		$(".sortouterHeight").css("background-image","url(images/dropbg.png)");
		var dragdropid  = parseInt(referenceToDragDropObject.numericIdToBeDragged) + 1;
		$("#box"+dragdropid).addClass("active-tool");
		//$(".mainLeftPanel .mainLeftPanelScroll li.listbox").addClass("active-tool");
		//$(".sortouterHeight li").css("box-shadow","2px 5px 7px #88ceff");
		$( ".sample2 tr td" ).hover(function(){
			$(".sample2 tr td").removeClass("opacity0");
	...
	__timerDragDropElement : function()
	{
		...
		if(this.dragDropTimer>=7){
			if(this.dragObjCloneArray[this.numericIdToBeDragged].style.display=='none'){
				...
				//this.dragObjCloneArray[this.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(this.dragDropSourcesArray[this.numericIdToBeDragged][0]) - 96 + 'px';
				
				if(referenceToDragDropObject.numericIdToBeDragged!=5 || referenceToDragDropObject.numericIdToBeDragged!=6 || referenceToDragDropObject.numericIdToBeDragged!=7){
					this.dragObjCloneArray[this.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(this.dragDropSourcesArray[this.numericIdToBeDragged][0]) - 96 + 'px';
				}
				if(referenceToDragDropObject.numericIdToBeDragged==7){
					this.dragObjCloneArray[this.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(this.dragDropSourcesArray[this.numericIdToBeDragged][0]) - 192 + 'px';
				}
				if(referenceToDragDropObject.numericIdToBeDragged==6){
					this.dragObjCloneArray[this.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(this.dragDropSourcesArray[this.numericIdToBeDragged][0]) - 288 + 'px';
				}
				if(referenceToDragDropObject.numericIdToBeDragged==5){
					this.dragObjCloneArray[this.numericIdToBeDragged].style.left = dhtmlSuiteCommonObj.getLeftPos(this.dragDropSourcesArray[this.numericIdToBeDragged][0]) - 384 + 'px';
				}
			}
	...
	__slideElementBackIntoItsOriginalPosition : function(numId)
	{
		...
		//For To hide the Drop Box Separately
		//$("#dropBox").css({"box-shadow":"1px 0px 5px transparent"});
		//$("#sortable").css({"box-shadow":"1px 0px 5px transparent"});
		$(".sortouterHeight").css("border-top","0px solid #afddff");
		$(".sortouterHeight").removeClass("borderbtm");
		$(".sortouterHeight").css("padding","0px");
		$(".sortouterHeight").css("z-index","inherit");/* drag box highlight */
		$(".sortouterHeight").css("background-image","none");
		$(".mainLeftPanel .mainLeftPanelScroll li.listbox").removeClass("active-tool");
		$( ".sample2 tr td" ).hover(function(){
	...
	{				
		...
		//this.dragObjCloneArray[numId].style.left = currentX - 96 + 'px';
		if(referenceToDragDropObject.numericIdToBeDragged!=5 || referenceToDragDropObject.numericIdToBeDragged!=6 || referenceToDragDropObject.numericIdToBeDragged!=7){
			this.dragObjCloneArray[numId].style.left = currentX - 96 + 'px';
		}
		if(referenceToDragDropObject.numericIdToBeDragged==7){
			this.dragObjCloneArray[numId].style.left = currentX - 192 + 'px';
		}
		if(referenceToDragDropObject.numericIdToBeDragged==6){
			this.dragObjCloneArray[numId].style.left = currentX - 288 + 'px';
		}
		if(referenceToDragDropObject.numericIdToBeDragged==5){
			this.dragObjCloneArray[numId].style.left = currentX - 384 + 'px';
		}
		...
		if(currentX!=targetX || currentY != targetY){
			...
			this.dragObjCloneArray[numId].style.display='none';
			this.dragDropSourcesArray[numId][0].style.visibility = 'visible';
			$(".mainLeftPanelScroll.nano").addClass("overflow");
			//$(".contentNanoScroll").css("top",$(".slider").css("top"));
			$(".mainLeftPanelScroll .contentNanoScroll").css("top","0");
			$(".mainLeftPanelScroll .contentNanoScroll").addClass("overflowxy");
			$(".mainLeftPanelScroll .contentNanoScroll").removeClass("width100");	
		}		
	}
}
