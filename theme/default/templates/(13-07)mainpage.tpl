					...
					{else}
						...
						{if $req_file_name eq 'main.php'}
							...
							{if $settingpage.0.payment_status eq 'No' or $settingpage.0.payment_status eq ''}
							  <li class="main_rightNav_buy"><a href="{$SITE_BASEURL}/{if $USERFRIENDLY eq 'Y'}subscription/{$smarty.session.domain_id}{else}subscription.php?domain_id={$smarty.session.domain_id}{/if}">Buy</a></li>
							{/if}	
			...
			<ul class="mainLeftPanelUl clearfix" id="toolssection">
				<li>
					<a class="mainTabNav basicnav active" href="javascript:void(0);" id="basic_section">
						<span class="inlineblock"><img src="{$SITE_BASEURL}/images/basic.png" alt="basic" title="basic" /></span><span class="inlineblock">Basic</span>
					</a>
				</li>
				<li>
					<a class="mainTabNav" href="javascript:void(0);" id="more_section">
						<span class="inlineblock"><img src="{$SITE_BASEURL}/images/social-icons2.png" alt="social" title="social" /></span><span class="inlineblock">Social</span>
					</a>
				</li>
				<li>
					<a class="mainTabNav" href="javascript:void(0);" id="media_section">
						<span class="inlineblock"><img src="{$SITE_BASEURL}/images/media2.png" alt="media2" title="media2" /></span><span class="inlineblock">Media</span>
					</a>
				</li>
				<li>
					<a class="mainTabNav" href="javascript:void(0);" id="structure_section">
						<span class="inlineblock"><img src="{$SITE_BASEURL}/images/structure2.png" alt="structure2" title="structure2" /></span><span class="inlineblock">Structure</span>
					</a>
				</li>			
			</ul>
					...
					<ul class="mainLeftPanelUlContent basictab">
						<li class="sectioncontent">
							<ul class="clearfix leftuldiv mainLeftPanelScrollActive">
								...
								<li class="dragableBox listbox" id="box13" data-title="box13"><div class="outerToolwrap"><span class="addonimgclass bgicon"></span><div class="title-box"><span class="title">Column</span></div></div></li>
							</ul>
						</li>
					</ul>
				</li>
					...
					<ul class="mainLeftPanelUlContent othertab">
						<li class="sectioncontent">
							<ul class="clearfix leftuldiv">
								...
								<li class="dragableBox listbox" id="box14" data-title="box14"><div class="outerToolwrap"><span class="fileiconclass bgicon"></span><div class="title-box"><span class="title">File</span></div></div></li>
					...
					<div class="selectTheme no-mar clearfix">
						...
						<div class="selectlist">
							<h3 class="fontlistdivHead marLftmin60 active">
								...
								<img src="{$SITE_BASEURL}/images/basic.png" alt="basic" title="basic" />
								<br/>
								{$LANG.main_page_select_options}<a class="fontback">BACK</a>
							</h3>
							<ul class="nav">
								<li id="site_title">
									<i class="fa fa-copy"></i> <br />
						...
						<div class="fontlistdiv fontlistdivSel" style="display:none;">
							<h3 class="fontlistdivHead marLftmin60 active">
								...
								<img src="{$SITE_BASEURL}/images/basic.png" alt="basic" title="basic" />
								<br/>
								{$LANG.main_page_select_font_family}<a class="fontback">BACK</a>
							</h3>
					...
					<div class="domainChangeOne">
						...
						<!--	<div class="head">{$LANG.main_choose_subdomain}</div>
							...
							<div class="chooseDomainInner">
								<form name="domainform" class="chooseDomainInnerForm" id="domainform" method="post">
									...
									<div class="chooseDomainSubdomain">
										...
										<input type="radio" name="domain" id="sub_domain" checked="checked" style="display:none;"/>{$LANG.main_http} <input type="text" id="domain_name" name="domainname"  value="" placeholder="example" onkeyup="checkDomainValidation();"/>{$SITE_MAIN_DOMAIN}
									</div>
								{*	<div class="chooseDomainAlreaydomain">
									...
									<div class="clearfix">
										<input type="button" class="saveButtonInput" name="setting_domain_submit" id="setting_domain_submit" value="{$LANG.main_continue}" onclick="AddSubDomain();" />
									</div>											
								</form>
							</div>
						</div>
...
<div id="modals">
    <div id="banner_slide_images_popup" class="sliderPopCont modal hide">
    	...
    	<div class="sliderPopupHead no_textindent">Background <a onclick="SaveBackgroundChanges();" class="savetobg">Save</a></div>
				...
				<div class="span12 slidePopRhtScroll backgroundpadding offset0">
					<div class="bgChangOnOff bannerswitch">
						<div class="button pull-left">
							<a onclick="changeBackgroundEnable('{$smarty.session.domain_id}',this);"  data-back="img" class="backstatus {if $banner_config eq '0' || $default_switch eq 'Y'}active{/if}">{$LANG.main_page_off}</a>
							<a onclick="changeBackgroundEnable('{$smarty.session.domain_id}',this);"  data-back="img" class="backstatus {if $banner_config eq '1' && $default_switch eq 'N'}active{/if}">{$LANG.main_page_on}</a>
						</div>
					</div>
					<div class="imagepreviewBG clearfix">
						<label class="bglabel selectbgimage">Image Preview :</label><span id="background_img"  class="bgboximage"><img src="{$SITE_DOMAIN_IMAGES_URL}/{$logoimages}" id="backimg" style="height:50px;width:100px"  /></span>
					</div>
					...
					<div id="background_imageLibrary" class="clearfix library_content">
						...
						<div id="my_computer" class="clearfix">
							...
							<div id="image_library_content" class="clearfix">
								<input type="button" class="upload_btn" value="Upload" style="display:none;" id="lipimguplod" onclick="uploadLibraryImages('{$smarty.session.domain_id}','{$smarty.session.page_id}','','background');" />
							<div class="backgroundLibrary">
		...
		<div class="span12 offset0">
    			<div class="bgTitle">Background Color</div>
				<div class="bgChangOnOff bannerswitch slidePopRhtScroll backgroundpadding">
					<div class="button pull-left">
						<a class="backstatus {if $backgroundcolor eq 'Y' || $default_switch eq 'Y'}active{/if}" data-back='color' onclick="changeBackgroundStatus(this);">{$LANG.main_page_off}</a>
						<a class="backstatus  {if $backgroundcolor eq 'N' && $default_switch eq 'N'}active{/if}" data-back='color' onclick="changeBackgroundStatus(this);">{$LANG.main_page_on}</a>
                        {*change_bg_color_popup_on*}
					</div>
					<label class="bglabel selectbgcolor">Select Color :</label><span style="background-color:{$backcolor}" class="bgboxcolor"></span>
		...
		<div class="span12 offset0">
    		<div class="bgTitle">Default Theme</div>
			<div class="bgChangOnOff bannerswitch slidePopRhtScroll backgroundpadding">
				<div class="button">
					<a class="backstatus defaultstatus1 {if $default_switch eq 'N'}active{/if}" data-back='default' onclick="changeBackgroundStatus_default('N',this);">{$LANG.main_page_off}</a>
					<a class="backstatus defaultstatus1 {if $default_switch eq 'Y'}active{/if}" data-back='default' onclick="changeBackgroundStatus_default('Y',this);">{$LANG.main_page_on}</a>
				</div>
			</div>
    	</div>
    	</div>
