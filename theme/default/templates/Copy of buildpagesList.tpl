...
<link href="{$SITE_CSS_URL}/design.css" type="text/css" rel="stylesheet" />
	...
	<div class="{$smarty.session.themecolorname}">
						...
						<div class="themewrapperRight">
							<div class="theme4Wrapper">
								...
								{section name="pages" loop="$buildpagelist1"}
									<li class="navTabSub">
										<a id="{$buildpagelist1[pages].page_id}" class="{if $smarty.session.page_id eq $buildpagelist1[pages].page_id}active{/if}"
									...
									<div id="showlogo">
										...
										<ul class="hovershowLogo">
											...
											{if $site_title.0.header_logo_config eq '2'}
												<li onclick="return imageShow()"><a onclick="$('#uploadImgPopup').show();$('#maska').show();"><span class="hovershowLogoArrowTop"></span>  {$LANG.edit_logo_name}</a></li>
											{/if}
											{else}
												<li onclick="return imageShow()"><a onclick="$('#uploadImgPopup').show();$('#maska').show();"><span class="hovershowLogoArrowTop"></span>  {$LANG.logo_name}</a></li>
											{/if}	
										</ul>
									</div>
								</div>
								...
								<div class="mainRhtBannerInner">
									{if $site_title.0.header_banner eq 0 and $site_title.0.header_slider eq 0}
										...
										<div class="mainRhtBannerInnerBanner" {if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages});"{/if}>
											...
											<a class="editbannerTxt" data-toggle="modal" {if $subsdetails.0.subs_monthly_date  le $current_date}href="{$SITE_BASEURL}/subscription.php"{else}href="#sliderBannerImg"{/if}>
									...
									{if $site_title.0.header_slider}
										...
										<div class="slideBannerRel">
											...
											<a class="slideeditSlide" data-toggle="modal" {if $subsdetails.0.subs_monthly_date  le $current_date}href="{$SITE_BASEURL}/subscription.php"{else}href="#sliderBannerImg"{/if}>
												{$LANG.slider_name} <i class="fa fa-caret-down"></i>
											</a>
							...
							<div class="mainRhtBannerInner">
									{if $site_title.0.header_banner eq 0 and $site_title.0.header_slider eq 0}
										...
										<div class="mainRhtBannerInnerBanner" {if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages});"{/if}>
											...
											<a class="editbannerTxt sliderhide" data-toggle="modal" {if $subsdetails.0.subs_monthly_date  le $current_date}href="{$SITE_BASEURL}/subscription.php"{else}href="#sliderBannerImg"{/if}>
												{$LANG.slider_name} <i class="fa fa-caret-down"></i>
											</a>
											<div class="themewrapper3">
												<div class="mainRhtBannerInnerRight">
			...
			<div class="footrAlign">
				...
				<div class="themewrapper1 themewrapper2 footerBgSource themewrapper3 themewrapper4 themewrapper5 themewrapper6">
					{if $subsdetails.0.subs_monthly_date  le $current_date}
						{$LANG.create_free_website} <a href="{$SITE_MAIN_DOMAIN}">{$LANG.webbxyz_name}</a><a class="footerbutton" href="{$SITE_BASEURL}/subscription.php" target="_blank">{$LANG.edit_name}</a>
					{else}
		...
		{literal}
            ...
            var store1 = $(".buildSection li a").text();
            var storeval = 'Store';
            if($(store1 != storeval)){
                alert("store1");
                $(".sliderhide").show();
