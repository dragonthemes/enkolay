...
<link href="{$SITE_CSS_URL}/design.css" type="text/css" rel="stylesheet" />
	...
	<div class="clearfix {$smarty.session.themecolorname} {if $smarty.session.themename eq 'theme9'}theme9{/if}">
		...
		<div class="themewrapper5 theme2Banner" {if $banner_config}{if $logoimages}style="background-image:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages}); background-size:100% 100%;"{/if}{/if}>
			<div class="theme5wrap">
				<div class="themewrapper4Cont wrapperCont5 clearfix" id="titheaddesUpdate">
					<div class="themeLeftSep mainRightPanelInnerTop">
						{if $smarty.session.themename eq 'theme4' OR $smarty.session.themename eq 'theme15' OR $smarty.session.themename eq 'store2' }
							...
							<div class="themewrapper1 themewrapper3 blogwrapper1 logoTopHover blogwrapper2">
								<div class="theme4Wrapper">
									<div class="blogthemeLogo" onmouseover="titleShow()"  onmouseout="titleHide()">
										...
										<div class="flt"><h2 class="mainPageThmeTitle site_title contentedit" id="updateTitle" contenteditable="true" onchange="return updateTitleIndex('{$smarty.session.domain_id}');" onblur="return updateTitleIndex('{$smarty.session.domain_id}');" style="{if $site_title.0.site_title_font_style}font-family:{$site_title.0.site_title_font_style};{/if}{if $site_title.0.site_title_font_size}font-size:{$site_title.0.site_title_font_size}px;{/if}{if $site_title.0.site_title_line_size}line-height:{$site_title.0.site_title_line_size}px;{/if}">{if $site_title.0.site_title}{$site_title.0.site_title}{else}{/if}</h2></div>
					 ...
					 onclick="showPageListinBuild('{$buildpagelist1[pages].page_id}','{$buildpagelist1[pages].domain_id}')">{$buildpagelist1[pages].pagename}</a>
						...
						{elseif $smarty.session.themename eq 'store3' }
							<div class="logoTopHoverOuter">
								<div class="themewrapper1 themewrapper3 blogwrapper1 logoTopHover blogwrapper2">
									<div class="themewrapperBgLft">
										<div class="theme4Wrapper">
											<div class="blogthemeLogo" onmouseover="titleShow()"  onmouseout="titleHide()">
												...
												{$objCommon->getImageForShowTop($site_title.0.domain_id,'domainlogo')}
												{if $site_title.0.header_logo_config eq '1'}
												<div class="flt"><h2 class="mainPageThmeTitle site_title contentedit" id="updateTitle" contenteditable="true"  data-ph="Edit Text Here"  onchange="return updateTitleIndex('{$smarty.session.domain_id}');" onblur="return updateTitleIndex('{$smarty.session.domain_id}');" style="{if $site_title.0.site_title_font_style}font-family:{$site_title.0.site_title_font_style};{/if}{if $site_title.0.site_title_font_size}font-size:{$site_title.0.site_title_font_size}px;{/if}{if $site_title.0.site_title_line_size}line-height:{$site_title.0.site_title_line_size}px;{/if}">{if $site_title.0.site_title}{$site_title.0.site_title}{else}{/if}</h2></div>
												{elseif $site_title.0.header_logo_config eq '2'}
													<div class="logodiv" style="{if $site_title.0.logo_left}left:{$site_title.0.logo_left}px;{/if}{if $site_title.0.logo_top}top:{$site_title.0.logo_top}px;{/if}"><img class="logoresize" src="{$SITE_DOMAIN_IMAGES_URL}/{$logoimages}" width="{if $site_title.0.logo_width}{$site_title.0.logo_width}{else}200{/if}" height="{if $site_title.0.logo_height}{$site_title.0.logo_height}{else}50{/if}"></div>
												{elseif $site_title.0.header_logo_config eq '0'}
							...
							<div class="themewrapperRight">
								<div class="theme4Wrapper">
								 ...
								 onclick="showPageListinBuild('{$buildpagelist1[pages].page_id}','{$buildpagelist1[pages].domain_id}')">{$buildpagelist1[pages].pagename}</a>*}
												...
												{else}
												<a class="{if $smarty.session.page_id eq $buildpagelist1[pages].page_id}active{/if}" onclick="showPageListinBuild('{$buildpagelist1[pages].page_id}','{$buildpagelist1[pages].domain_id}')">{$buildpagelist1[pages].pagename}</a>
										  {/if}
											<ul>
												{$objCommon->getSubPages($buildpagelist1[pages].page_id,$site_title.0.domain_id)}
												{section name="submenu" loop=$subbuildpagelist}
					...
					{if $smarty.session.themeOnuse}
						...
						<div class="themeRightSepOuter">
							<div class="themeRightSep">
								...
								{if $smarty.session.themename eq 'theme1' OR $smarty.session.themename eq 'theme10'}
												...
												<div class="themewrapper3">
													<div class="mainRhtBannerInnerRight">
														...
														<h2 class="mainRhtBannerInnerHead main_headline" style="{if $site_title.0.main_headline_font_style}font-family:{$site_title.0.main_headline_font_style};{/if}{if $site_title.0.main_headline_font_size}font-size:{$site_title.0.main_headline_font_size}px;{/if}{if $site_title.0.main_headline_line_size}line-height:{$site_title.0.main_headline_line_size}px;{/if}">
															<div id="headingContent" contenteditable="true" data-ph="Edit Headline Here"  class="minhead headlimit contentedit {if $site_title.0.heading_content eq ''}clickheretext contenttext{/if}" onblur="updateHeading('{$smarty.session.domain_id}')" onchange="updateHeading('{$smarty.session.domain_id}')" >{if $site_title.0.heading_content}{$site_title.0.heading_content}{/if}</div>
														</h2>
														<!--<div class="mainRhtBannerInnerDesc contentedit{if $site_title.0.heading_description eq ''} clickheretext contenttext{/if}" id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  onblur="updateDescriptionTitle('{$smarty.session.domain_id}')" onchange="updateDescriptionTitle('{$smarty.session.domain_id}')" style="{if $site_title.0.site_title_font_style}font-family:{$site_title.0.site_title_font_style};{/if}{if $site_title.0.site_title_font_size}font-size:{$site_title.0.site_title_font_size}px;{/if}{if $site_title.0.site_title_line_size}line-height:{$site_title.0.site_title_line_size}px;{/if}">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>-->
														<div class="mainRhtBannerInnerDesc contentedit{if $site_title.0.heading_description eq ''} clickheretext contenttext{/if}" id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  onblur="updateDescriptionTitle('{$smarty.session.domain_id}')" onchange="updateDescriptionTitle('{$smarty.session.domain_id}')">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>
													</div>
												</div>
											</div>
											 {/if}
									...
									{if $site_title.0.header_banner eq 0 and $site_title.0.header_slider eq 0}
										<div class="mainRhtBannerInnerBanner clr">
											<div class="paddlefRht">
												...
												<div id="banner">
													<div id="bannerleft">
														<div class="wsite-header" {if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages}); background-size:100% 100%;"{/if}>
															<a class="editbannerTxt" data-toggle="modal" href="#editBannerImg">
																{$LANG.edit_image_name} <i class="fa fa-caret-down"></i>
															</a>
															<a class="editbannerTxt" data-toggle="modal" href="#sliderBannerImg">
													...
													<div id="bannerright">
														<div class="bannerrightCont">
															...
															<div id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  class="contentedit {if $site_title.0.heading_description eq ''}clickheretext contenttext{/if}" onblur="updateDescriptionTitle('{$smarty.session.domain_id}')" onchange="updateDescriptionTitle('{$smarty.session.domain_id}')">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>
														</div>
													</div>
												</div>
												 {/if}
	...
	src="{$SITE_DOMAIN_IMAGES_URL}/{$banner_images[sliimg].image_name}"/> 	 
													</div>
												{/section}
											</div>
										</div>
								...
								{*elseif $smarty.session.themename eq 'theme4' OR $smarty.session.themename neq 'theme15'*}
								...
								{elseif $smarty.session.themename eq 'theme5' OR $smarty.session.themename eq 'theme11' OR $smarty.session.themename eq 'theme12' OR $smarty.session.themename eq 'theme13' OR $smarty.session.themename eq 'theme14'}
									{if $site_title.0.header_banner eq 0 and $site_title.0.header_slider eq 0}
										<div class="mainRhtBannerInner">
											{$objCommon->getImageForShowTop($site_title.0.domain_id,'bannerimage')}
											{$objCommon->getBannerStatus($smarty.session.page_id)}
													 ...
													 {section name="bannersliimg" loop="$sliderimages"}
														<div class="imageSlider">
															...
															<div class="slideimageInn">
																<a onclick="deleteSliderBannerImage('{$sliderimages[bannersliimg].banner_slider_id}');" class="galleryimage"><i class="fa fa-trash-o"></i></a>
													...
													{section name="pagelist" loop="$pagefirstlist"}
														<!--<div id="dropBox2" class="dropBox2 clearfix" style="position:relative;">-->
															{if $pagefirstlist[pagelist].column_show}
																<li id="page_{$pagefirstlist[pagelist].pagelist}" class="">
															...
															<div id="buildImgTxt_{$pagefirstlist[pagelist].pagelist}" class="buildImgTxtOuter">
																<div class="row-fluid ">
																	<div class="span3 buildImgTxt {if !$images}minimagewidth{/if}">
																		...
																		{else}
																			<div class="uploadImgBg">
																				<img class="imagechangeNew"  width="{if $pagefirstlist[pagelist].img_width}{$pagefirstlist[pagelist].img_width}{else}100%{/if}" height="{if $pagefirstlist[pagelist].img_height}{$pagefirstlist[pagelist].img_height}{else}180{/if}" src="{$SITE_DOMAIN_IMAGES_URL}/{$images}">
																				{*<div id='preview_{$pagefirstlist[pagelist].pagelist}'>
																				</div>*}
													   ...
													   {$objCommon->getAllContactDetails($pagefirstlist[pagelist].pagelist)}
														<li id="page_{$pagefirstlist[pagelist].pagelist}" class="activemove theme2bginn">
															...
															<div id="" class="contactform">
																...
																<a data-toggle="modal" href="#ModalFormEntry_{$pagefirstlist[pagelist].pagelist}" class="formEntryButton pull-right">Form Girişleri</a>
																<div class="themeheadsec contentedit {if $contactlist.0.title_head eq ''}clickheretext contenttext {/if}contactTxt contactHead" style="{if $contactlist.0.buildContact_fontsize}font-size:{$contactlist.0.buildContact_fontsize}px;{/if}{if $contactlist.0.buildContact_fontcolor}color:{$contactlist.0.buildContact_fontcolor}{/if}{if $contactlist.0.buildContact_font_style}font-family:{$contactlist.0.buildContact_font_style};{/if}{if $contactlist.0.buildContact_line_size}line-height:{$contactlist.0.buildContact_line_size}px;{/if}{if $contactlist.0.buildContact_font_size}font-size:{$contactlist.0.buildContact_font_size}px;{/if}" id="buildContact_{$contactlist.0.id}" onmouseout="updateContactFormTitle('buildContact_{$contactlist.0.id}');" data-ph="Edit Heading Here">{if $contactlist.0.title_head}{$contactlist.0.title_head}{/if}</div>
																<div class="row-fluid"> 	
																...
																<div id="galPopup_{$pagefirstlist[pagelist].pagelist}" style="display:none;" class="galleryimagepop">
																	<form name="galleryPopup_{$pagefirstlist[pagelist].pagelist}" method="post">
																		...
																		<div class="rightside">
																			...
																			<div class="clearfix">
																				<input type="button" class="btn btn-success pull-left" value="save" onclick="addgalleryProcess('{$pagefirstlist[pagelist].pagelist}');" />
																				<input type="button" class="btn btn-danger pull-right gallerycancel" value="cancel" />
																			</div>
																		</div>
																	</form>
																	...
																	<div id="galimgpopup_{$pagefirstlist[pagelist].pagelist}" class="modal fade hide" aria-hidden="false">
																		...
																		<div id="browsebutton" class="popBrowseInner">
																			...
																			<form id="galimagephotogal{$pagefirstlist[pagelist].pagelist}" class="form-horizontal sky-form no-mar" method="post" enctype="multipart/form-data" action='ajaxGalleryImageUpload.php' style="clear:both">
																				...
																				<label for="file" class="input input-file no-mar" style="display:block" name="imageloadbutton" id="imageloadbutton">
																					<div class="button">
																						<input type="file" class="hei180" value="" onchange="galimagupdate('{$pagefirstlist[pagelist].pagelist}')" name="photos[]" id="galimgphoto">
																					</div>
																					<input type='hidden' name="page_list_id" value="{$pagefirstlist[pagelist].pagelist}"/>
																				</label>
																			</form>
																...
																<div id="mapframe_{$pagefirstlist[pagelist].pagelist}" class="mappop" style="display:none;">
																	...
																	<div class="rightside">
																		<form name="mapframepopup_{$pagefirstlist[pagelist].pagelist}" class="no-mar" method="post">
																			...
																			<div class="mapButton clearfix">
																				<input type="button" value="Kaydet" class="btn btn-success"  onclick="addMapProcess('{$pagefirstlist[pagelist].pagelist}');" />
													...
													{if $pagefirstlist[pagelist].slider}
														 <li id="page_{$pagefirstlist[pagelist].pagelist}" class="activemove theme2bginn">
															...
															<div id="sliImg_{$pagefirstlist[pagelist].pagelist}" class="row-fluid hoverSlide">
																{$objCommon->getSliderImageNew($pagefirstlist[pagelist].pagelist)}
																...
																<div id="sliderform">
																	{if $slider_images}
																		<a class="sliderNoImg2" onclick="return showsliderFunc('{$pagefirstlist[pagelist].pagelist}');">Düzenle</a>
																	{/if}
																	{if !$slider_images}
																		<a class="sliderNoImg1" onclick="return showsliderFunc('{$pagefirstlist[pagelist].pagelist}');"></a>
																	{/if}
																</div>
															</div>
														</li>  
	...
	{if $smarty.session.themename eq 'theme2' or $smarty.session.themename eq 'theme5' or $smarty.session.themename eq 'theme11' or $smarty.session.themename eq 'theme12' or $smarty.session.themename eq 'theme13' OR $smarty.session.themename eq 'theme14'}
			...
			<div class="themewrapper5 themepadnone">
				<div class="footrAlign">
                    ...
                    {$objCommon->getCurrentDomainDetails()}
							...
							<div class="contentedit" contenteditable="true" onblur="return updateFooterContent();" onkeyup="return updateFooterContent();" id="footer_main">{if $settingpage.0.footer_content}{$settingpage.0.footer_content}{else}{$LANG.create_free_website} <a href="http://{$SITE_MAIN_DOMAIN}">{$SITE_MAIN_DOMAIN}</a>{/if}</div>
							 
						
					</div>
				</div>
			</div>
	{elseif $smarty.session.themename eq 'theme1' or $smarty.session.themename eq 'theme3' or $smarty.session.themename eq 'theme4' or $smarty.session.themename eq 'theme15' or $smarty.session.themename eq 'theme6' or $smarty.session.themename eq 'theme7' or $smarty.session.themename eq 'theme8' or $smarty.session.themename eq 'theme9' or $smarty.session.themename eq 'theme14'}
			<div class="clearfix clr"></div>
			<div class="footrAlign">
				<div class="footerWrapTop8"></div>
				<div class="themewrapper1 themewrapper2 footerBgSource themewrapper3 themewrapper4 themewrapper5 themewrapper6">
	...
	{elseif $smarty.session.themename eq 'blog1' or $smarty.session.themename eq 'blog2' or $smarty.session.themename eq 'blog3'}
		<div class="clearfix clr"></div>
		<div class="footrAlign">
			<div class="footerWrapTop8"></div>
			<div class="themewrapper1 themewrapper2 footerBgSource themewrapper3 themewrapper4 themewrapper5 themewrapper6">
