											...
											<div id="banner">
												...
												<div id="bannerright">
													<div class="bannerrightCont">
														...
														<p id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  class="contentedit {if $site_title.0.heading_description eq ''}clickheretext contenttext{/if}" onblur="updateDescriptionTitle('{$smarty.session.domain_id}')">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</p>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="mainRhtBannerInnerBanner" {if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages});"{/if}>
											...
											<div class="themewrapper3">
												<div class="mainRhtBannerInnerRight">
													...
													<div class="mainRhtBannerInnerDesc contentedit{if $site_title.0.heading_description eq ''} clickheretext contenttext{/if}" id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  onblur="updateDescriptionTitle('{$smarty.session.domain_id}')" style="{if $site_title.0.site_title_font_style}font-family:{$site_title.0.site_title_font_style};{/if}{if $site_title.0.site_title_font_size}font-size:{$site_title.0.site_title_font_size}px;{/if}{if $site_title.0.site_title_line_size}line-height:{$site_title.0.site_title_line_size}px;{/if}">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>
                                                </div>
											</div>
										</div>
									{/if}
																				...
																				<div id="galPopup_{$columnpagefirstlist[colpagelist].pagelist}" style="display:none;" class="galleryimagepop">
																					<form name="galleryPopup_{$columnpagefirstlist[colpagelist].pagelist}" method="post">
																						<div class="leftside">
																							...
																							<div class="clr"></div>
																							<a onclick="$('#galimgpopup_{$columnpagefirstlist[colpagelist].pagelist}').show();$('#masktable').show();$('.imagepopupdiv').css('top',100);" style="cursor:pointer;">{$LANG.add_image_name}</a>
																						</div>
																						<div class="rightside">
