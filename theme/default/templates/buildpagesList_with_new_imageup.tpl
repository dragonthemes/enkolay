											...
											<li id="page_{$pagefirstlist[pagelist].pagelist}" class="activemove theme2bginn">
												...
												<div id="buildImg_{$pagefirstlist[pagelist].pagelist}" class="row-fluid buildimage" title="{$pagefirstlist[pagelist].pagelist}" style="">
													{if !$images}
														...
														<div class="NoImgPopOuter">
															<a id="output" class="NoImgPopOuterImg" href="#imageform_{$pagefirstlist[pagelist].pagelist}" data-toggle="modal"></a>
															<div id="modals">
																<div class="modal ImageUploadInner fade hide" id="#imageform_{$pagefirstlist[pagelist].pagelist}" aria-hidden="false">
																	 <form action="ajaxImageDrag.php" method="post" enctype="multipart/form-data" id="imageform_{$pagefirstlist[pagelist].pagelist}" class="UploadForm " style="clear:both">
																	 	<div class="ImageUploadInnerText">Upload Image</div>
																		<label id='imageloadbutton_{$pagefirstlist[pagelist].pagelist}' class="input input-file" style="display:block; height:135px;" for="file">
																			<div class="button">
																				<input type='file' name="photos[]" id="photoimg_{$pagefirstlist[pagelist].pagelist}" class="inputfile" />
																			</div>
																		</label>
																		<input type="submit" class="addPageTab pull-right" id="SubmitButton" value="Upload" />
																		<input type='hidden' name="status" value="singleimage"/>
																		<input type='hidden' name="page_list_id" value="{$pagefirstlist[pagelist].pagelist}"/>
																	</form>
																	<!--<div id="output"><img src="{$SITE_IMAGE_URL}/uploadimage.png"></div>-->
																	<input type="hidden" name="imagesuploadNumbers" id="{$pagefirstlist[pagelist].pagelist}"/>	
																</div>
																<div class="uploadProgress">
																	<div class="uploadProgText">Uploading...</div>
																	<div id="progressbox"><div id="progressbar"></div ><div id="statustxt">0%</div ></div>
																	<div class="uploadProgClose">Close</div>
																</div>
															</div>
														</div>
												...
												{else}
													<div class="uploadImgBg">
														<div ><img width="{if $pagefirstlist[pagelist].img_width}{$pagefirstlist[pagelist].img_width}{else}100%{/if}" height="{if $pagefirstlist[pagelist].img_height}{$pagefirstlist[pagelist].img_height}{/if}" src="{$SITE_DOMAIN_IMAGES_URL}/{$images}"></div>
														<div class="NoImgPopOuter">
															<a id="output" class="InImgPopOuterImg" href="#imageform_{$pagefirstlist[pagelist].pagelist}" data-toggle="modal"></a>
															<div id="modals">
																<div class="modal ImageUploadInner fade hide" id="#imageform_{$pagefirstlist[pagelist].pagelist}" aria-hidden="false">																	
																 	<form id="imageform_{$pagefirstlist[pagelist].pagelist}" class="form-horizontal sky-form UploadForm" method="post" enctype="multipart/form-data" action='ajaxImageDrag.php'>
                                                                         <div class="ImageUploadInnerText">Upload Image</div>
																		<label id='imageloadbutton_{$pagefirstlist[pagelist].pagelist}' class="input input-file" style="display:block; height:135px;" for="file">
																			<div class="button">
																				<input type='file' name="photos[]" id="photoimg_{$pagefirstlist[pagelist].pagelist}" class="inputfile" onchange="imageUpdatingProcess('{$pagefirstlist[pagelist].pagelist}');"/>
