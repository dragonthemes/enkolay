...
<link href="{$SITE_CSS_URL}/design.css" type="text/css" rel="stylesheet" />
	...
	<div class="{$smarty.session.themecolorname}">
		...
		<div class="themewrapper5 theme2Banner" {if $banner_config}{if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages});"{/if}{/if}>
						...
						<div class="themewrapper1 themewrapper3 blogwrapper1 logoTopHover blogwrapper2">
							<div class="theme4Wrapper">
								<div class="blogthemeLogo" onmouseover="titleShow()"  onmouseout="titleHide()">
									...
									<div class="flt"><h2 class="mainPageThmeTitle site_title contentedit" id="updateTitle" contenteditable="true" onmouseout="return updateTitleIndex('{$smarty.session.domain_id}');" style="{if $site_title.0.site_title_font_style}font-family:{$site_title.0.site_title_font_style};{/if}{if $site_title.0.site_title_font_size}font-size:{$site_title.0.site_title_font_size}px;{/if}{if $site_title.0.site_title_line_size}line-height:{$site_title.0.site_title_line_size}px;{/if}">{if $site_title.0.site_title}{$site_title.0.site_title}{else}{$LANG.main_blog_title}{/if}</h2></div>
											...
											<div class="themewrapper3">
												<div class="mainRhtBannerInnerRight">
													<h2 class="mainRhtBannerInnerHead main_headline" style="{if $site_title.0.main_headline_font_style}font-family:{$site_title.0.main_headline_font_style};{/if}{if $site_title.0.main_headline_font_size}font-size:{$site_title.0.main_headline_font_size}px;{/if}{if $site_title.0.main_headline_line_size}line-height:{$site_title.0.main_headline_line_size}px;{/if}">
														<div id="headingContent"  contenteditable="true" class="contentedit {if $site_title.0.heading_content eq ''}clickheretext contenttext{/if}" onmouseover="updateHeading('{$smarty.session.domain_id}')" >{if $site_title.0.heading_content}{$site_title.0.heading_content}{/if}</div>
													</h2>
													<div class="mainRhtBannerInnerDesc contentedit{if $site_title.0.heading_description eq ''} clickheretext contenttext{/if}" id="headingdescription" contenteditable="true" onmouseover="updateDescriptionTitle('{$smarty.session.domain_id}')">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>
												</div>
											</div>
										</div>
									{/if}
											...
											<div id="banner">
												...
												<div id="bannerright">
													<div class="bannerrightCont">
														...
														<p id="headingdescription" contenteditable="true" class="contentedit {if $site_title.0.heading_description eq ''}clickheretext contenttext{/if}" onmouseover="updateDescriptionTitle('{$smarty.session.domain_id}')">{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</p>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="themeRightSep">
					<div class="mainRhtBannerInner replaceStoreBg paddRound20 clearfix" id="replaceStore">
						...
						{if $smarty.session.page_id}
							...
							<div class="storeMainPageHead">Category</div>
							<div class="storeMainPage row-fluid">
								...
								{section name="cat" loop="$categories"}
									...
									<div class="storeMainPageInner span4 {if $smarty.section.cat.index eq  '3'} offset0 {/if}">
									...
									{*=====Store  and their function starts======*}
										...
										{*	<div class="storeMainPageHead">Category</div>*}
												<div class="storeMainPage">
													...
													{section name="cat" loop="$categories"}
														{$objCommon->getCategoriesImages($categories[cat].store_cat_id,$categories[cat].domain_id)}
														<div class="storeMainPageInner">
														
															{if $categoriesImages}
																<img src="{$SITE_CAT_IMAGES_URL}/{$categoriesImages}" alt="category images" width="100%" height="242">
															{else}
																<img src="{$SITE_BASEURL}/images/blank-category.png" alt="Categories images" width="100%" height="242">
															{/if}
															{if $categories[cat].cat_name}<a onclick="return showAllCorrsProducts('{$categories[cat].store_cat_id}','{$categories[cat].domain_id}');">{$categories[cat].cat_name}</a>{/if}
														</div>
												 	{/section}
												</div>
												<div class="clr"></div>
											<!----for list categories and its images end------>
											{*<div class="storeMainPageHead marTop20">Product</div>*}
											<!----for list categories and its images start------>
											<div class="storeMainPageProduct">
												{$objCommon->getProducts($smarty.session.domain_id)}
												{section name="prod" loop="$productsListInCatPage"}
													<div class="storeMainPageProductInner {if $smarty.section.prod.index eq  '3'} offset0 {/if}">
														...
														{/if}
														<div class="procutName">{if $productsListInCatPage[prod].product_name}<a onclick="showProductViewPage('{$productsListInCatPage[prod].product_id}','{$productsListInCatPage[prod].domain_id}');">{$productsListInCatPage[prod].product_name}</a>{/if}</div>
														<div class="proctPrice">{$productsListInCatPage[prod].sale_price}</div>
													</div>
												{sectionelse}
							...
							<div class="storeMainPageHead marTop20">Product</div>
							<!----for list categories and its images start------>
							<div class="storeMainPageProduct row-fluid">
								{$objCommon->getProducts($smarty.session.domain_id)}
								{section name="prod" loop="$productsListInCatPage"}
									<div class="storeMainPageProductInner span3 {if $smarty.section.prod.index eq  '4'} offset0 {/if}">
										{$objCommon->getProductsImages($productsListInCatPage[prod].product_id,$productsListInCatPage[prod].domain_id)}
										{if !empty($pro_images)}
											<img src="{$SITE_PRODUCT_IMAGES_URL}/{$pro_images}" alt="Product images" width="200" height="210">
										{else}
											<img src="{$SITE_BASEURL}/images/blank-product.png" alt="Product images" width="200" height="210">
										{/if}
										<div class="procutName">{if $productsListInCatPage[prod].product_name}<a onclick="showProductViewPage('{$productsListInCatPage[prod].product_id}','{$productsListInCatPage[prod].domain_id}');">{$productsListInCatPage[prod].product_name}</a>{/if}</div>
										<div class="proctPrice">{$productsListInCatPage[prod].sale_price}</div>
									</div>
		...
		<div class="blogPageInner">
			<div class="blogPageInnerBg blogPageThemeBg">
				<div class="blogwrapper1 blogwrapper2 theme4Wrapper blog2wrapper">
					{if $smarty.session.themename eq 'store2'}
						{if $smarty.session.storeonuse}
							<div class="themeRightSep">
								<div class="mainRhtBannerInner replaceStoreBg paddRound20 clearfix" id="replaceStore">
											{if $smarty.session.page_id}
													...
													{if $smarty.session.page_id}
														...
														<div class="storeMainPageHead">Category</div>
															<div class="storeMainPage row-fluid">
																...
																{section name="cat" loop="$categories"}
																	{$objCommon->getCategoriesImages($categories[cat].store_cat_id,$categories[cat].domain_id)}
																	<div class="storeMainPageInner span4 {if $smarty.section.cat.index eq  '3' and $smarty.section.cat.index eq '0'} offset0 {/if}">
														...
														<div class="storeMainPageProduct row-fluid">
															{$objCommon->getProducts($smarty.session.domain_id)}
															{section name="prod" loop="$productsListInCatPage"}
																<div class="storeMainPageProductInner span3 {if $smarty.section.prod.index eq  '4' and $smarty.section.cat.index eq '0'} offset0 {/if}">
																	{$objCommon->getProductsImages($productsListInCatPage[prod].product_id,$productsListInCatPage[prod].domain_id)}
																	{if !empty($pro_images)}
																		<img src="{$SITE_PRODUCT_IMAGES_URL}/{$pro_images}" alt="Product images" width="200" height="210">
																	{else}
							...
							<div id="rightColumn" class="clearfix"> 
													...
													<div class="blogInner">
														...
														<div class="blogRight">	
															...
															{*	<div class="popaddTitleHead marTop10"><div class="popaddTitleHeadBg"><div class="popaddTitleHeadBgCol">{$LANG.user_blog_archives}</div></div></div>*}
																...
																<div class="authCont">{$smarty.now|date_format}</div>
								...
								{if !$objCommon->getBlogComment($smarty.session.page_id)}
										...
										<ul id="sortable" class="clearfix">
											...
											<li id="page_{$pagefirstlist[pagelist].pagelist}" class="activemove theme2bginn">
												...
												<!--<table onmouseover="columnId(this);" onmouseleave="columnIdOut(this);" class="sample2 columsBor" width="100%" border="0" cellpadding="0" cellspacing="0">-->
													<table class="sample2 columsBor" width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr>
													 ...
													 {section name="rowcount" start=1 loop=$pagefirstlist[pagelist].column_count}
														...
														<input type="hidden" name="columnpagelistid" id="columnpagelistid" class="columnpagelistid" value="{$pagefirstlist[pagelist].pagelist}">
															<!---COlumn Sortable---->
															<ul id="sortable_{$smarty.section.rowcount.index}" class="clearfix no-mar">
																					...
																					<div class="span3">
																						...
																						{else}
																							<div class="uploadImgBg">
																								<img width="100%" height="180" src="{$SITE_DOMAIN_IMAGES_URL}/{$images}">
																								{*<div id='preview_{$columnpagefirstlist[colpagelist].pagelist}'>
																								</div>*}
																								<div id='imageloadstatus_{$columnpagefirstlist[colpagelist].pagelist}' style='display:none'><div class="laodImgChange"><img src="{$SITE_BASEURL}/images/gifload.gif" alt="Uploading...."/></div></div>
																	...
																	<li id="page_{$columnpagefirstlist[colpagelist].pagelist}" class="activemove theme2bginn posRel">
																		...
																		{else}
																			<div class="uploadImgBg">
																				<img width="{if $columnpagefirstlist[colpagelist].img_width}{$columnpagefirstlist[colpagelist].img_width}{else}100%{/if}" height="{if $columnpagefirstlist[colpagelist].img_height}{$columnpagefirstlist[colpagelist].img_height}{/if}" src="{$SITE_DOMAIN_IMAGES_URL}/{$images}">
																				{*<div id='preview_{$columnpagefirstlist[colpagelist].pagelist}'>
																				</div>*}
																				<div id='imageloadstatus_{$columnpagefirstlist[colpagelist].pagelist}' style='display:none'><div class="laodImgChange"><img src="{$SITE_BASEURL}/images/gifload.gif" alt="Uploading...."/></div></div>
																				<form id="imageform_{$columnpagefirstlist[colpagelist].pagelist}" class="form-horizontal sky-form uploadsecbg" style="margin:-37px 0 0;" method="post" enctype="multipart/form-data" action='ajaxImageUpload.php' style="clear:both">
																					<label id='imageloadbutton_{$columnpagefirstlist[colpagelist].pagelist}' class="input input-file" style="display:block" for="file">
																						<div class="button">
																							<input type='file' name="photos[]" id="photoimg_{$columnpagefirstlist[colpagelist].pagelist}" class="inputfile" onchange="imageUpdatingProcess('{$columnpagefirstlist[colpagelist].pagelist}');"/>
																						</div>
																			...
																			<div id="galImg_{$columnpagefirstlist[colpagelist].pagelist}" class="row-fluid">
																			 ...
																			 {else}
																			  ...
																			  <!--Gallery Image Popup-->
																				<div id="galPopup_{$columnpagefirstlist[colpagelist].pagelist}" style="display:none;" class="galleryimagepop">
																					<form name="galleryPopup_{$columnpagefirstlist[colpagelist].pagelist}" method="post">
																						<div class="leftside">
																							...
																							<div class="clr"></div>
																							<a data-toggle="modal" href="#galimgpopup_{$columnpagefirstlist[colpagelist].pagelist}">{$LANG.add_image_name}</a>
																						</div>
																						<div class="rightside">
																				...
																				<div id="modals">
																					<div id="galimgpopup_{$columnpagefirstlist[colpagelist].pagelist}" class="modal fade hide" aria-hidden="false">
																	 ...
																	 <li id="page_{$columnpagefirstlist[colpagelist].pagelist}" class="activemove theme2bginn posRel">
																		...
																		<div id="sliImg_{$columnpagefirstlist[colpagelist].pagelist}" class="row-fluid hoverSlide">
																		 ...
																		 {if $images}
																			 ...
																			 <a data-toggle="modal" class="hoverSlideShow" href="#slimgpopup_{$columnpagefirstlist[colpagelist].pagelist}">
																				{$LANG.add_image_name}
																			 </a>											 
																			 <div id="modals">
											...
											<li id="page_{$pagefirstlist[pagelist].pagelist}" class="activemove theme2bginn">
												...
												<div id="buildImg_{$pagefirstlist[pagelist].pagelist}" class="row-fluid">
												 {if !$images}
													{*<div id='preview_{$pagefirstlist[pagelist].pagelist}'>
													</div>*}
												...
												{else}
													<div class="uploadImgBg">
														<img width="{if $pagefirstlist[pagelist].img_width}{$pagefirstlist[pagelist].img_width}{else}100%{/if}" height="{if $pagefirstlist[pagelist].img_height}{$pagefirstlist[pagelist].img_height}{/if}" src="{$SITE_DOMAIN_IMAGES_URL}/{$images}">
														{*<div id='preview_{$pagefirstlist[pagelist].pagelist}'>
														</div>*}
														<div id='imageloadstatus_{$pagefirstlist[pagelist].pagelist}' style='display:none'><div class="laodImgChange"><img src="{$SITE_BASEURL}/images/gifload.gif" alt="Uploading...."/></div></div>
														...
														<div id="galPopup_{$pagefirstlist[pagelist].pagelist}" style="display:none;" class="galleryimagepop">
															<form name="galleryPopup_{$pagefirstlist[pagelist].pagelist}" method="post">
																<div class="leftside">
																	<i class="fa fa-picture-o"></i>
																	<div class="clr"></div>
																	<a data-toggle="modal" href="#galimgpopup_{$pagefirstlist[pagelist].pagelist}">{$LANG.add_image_name}</a>
																</div>
																<div class="rightside">
																	<label>{$LANG.add_image_name}</label>
									...
									{/section}
										...
										<div class="dragElemBg">
											<img src="{$SITE_BASEURL}/images/click-elements-here.png" alt="Draggable Element" />
											<div class="dragTxt">{$LANG.drag_element_here}</div>
										</div>
			...
			<div class="footrAlign">
				...
				<div class="themewrapper1 themewrapper2 footerBgSource themewrapper3 themewrapper4 themewrapper5 themewrapper6">
					{if $subsdetails.0.subs_monthly_date  le $current_date}
						{$LANG.create_free_website} <a href="{$SITE_MAIN_DOMAIN}">{$LANG.webbxyz_name}</a><a class="footerbutton" href="{$SITE_BASEURL}/{if $USERFRIENDLY eq 'Y'}subscription{else}subscription.php{/if}" target="_blank">{$LANG.edit_name}</a>
					{else}
						<div class="contentedit" contenteditable="true" onmouseout="return updateFooterContent();" id="footer_main">{if $settingpage.0.footer_content}{$settingpage.0.footer_content}{else}{$LANG.create_free_website} <a href="{$SITE_MAIN_DOMAIN}">{$LANG.webbxyz_name}</a>{/if}</div>
