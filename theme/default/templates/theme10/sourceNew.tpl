			...
			{if $domain_details}
				<div class="sourceNewThene">
					<div class="row-fluid">
                                ...
                                <div class="container">
                                    <div class="navbar">
                                        ...
                                        <!--to show  site title start-->
                                            ...
                                            <div class="mainPageThmeTitle pull-left" style="{if $domain_details.0.site_title_font_style}font-family:{$domain_details.0.site_title_font_style};{/if}{if $domain_details.0.site_title_font_size}font-size:{$domain_details.0.site_title_font_size}px;{/if}{if $domain_details.0.site_title_line_size}line-height:{$domain_details.0.site_title_line_size}px;{/if}"><a href="{$SITE_SOURCE_BASEURL}">{$domain_details.0.site_title}</a></div>
                                            ...
                                            <div class="themelogoposition pull-left" style="{if $domain_details.0.logo_left}left:{$domain_details.0.logo_left}px;{/if}{if $domain_details.0.logo_top}top:{$domain_details.0.logo_top}px;{/if}">
						...
						<div class="themewrapper4Cont"><div class="headerNavShadow"></div></div>
