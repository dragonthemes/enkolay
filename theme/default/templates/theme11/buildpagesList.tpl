...
<div class="clearfix {$smarty.session.themecolorname} {if $smarty.session.themename eq 'theme9'}theme9{/if}">
	...
	<div class="themewrapper5 theme2Banner clearfix" id="theme_background" style="{if $banner_config}{if $logoimages && $default_switch eq 'N'}background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages}); background-size:100% 100%;{/if}{else}{if $background_color.0.background_color neq '' && $background_color.0.background_color_off eq 'N' && $default_switch eq 'N'}background-color:{$background_color.0.background_color}{/if}{/if}">
