                            ...
                            <div class="mainRhtBanner clearfix">
                                ...
                                <div class="mainRhtBannerInner">
                                    ...
                                    <div class="mainRhtBannerInnerBanner relative" {if $logoimages}style="background:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages});"{/if}>
                                        ...
                                        <a class="editbannerTxt theme4editimg"  {if $subsdetails.0.subs_monthly_date  le $current_date}href="{$SITE_BASEURL}/{if $USERFRIENDLY eq 'Y'}subscription{else}subscription.php{/if}"{else} onclick="$('#sliderBannerImg').show();$('.loadmask').show();" {/if}>
