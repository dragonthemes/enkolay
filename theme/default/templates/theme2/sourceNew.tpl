                          ...
                          <div class="logoTopHover clearfix">
	                         <div class="navbar">
                                ...
                                <!--to show  site title start-->
                                    ...
                                    <div class="themewrapperLeft mainPageThmeTitle" style="{if $domain_details.0.site_title_font_style}font-family:{$domain_details.0.site_title_font_style};{/if}{if $domain_details.0.site_title_font_size}font-size:{$domain_details.0.site_title_font_size}px;{/if}{if $domain_details.0.site_title_line_size}line-height:{$domain_details.0.site_title_line_size}px;{/if}"><a href="{$SITE_SOURCE_BASEURL}">{$domain_details.0.site_title}</a></div>
                        ...
                        <div class="mainRhtBanner clearfix">
                            ...
                            {if $domain_details.0.header_banner}
                                <div class="paddlefRht">
                                    <div class="top-divider"></div>
                                    {$objCommon->getImageForShowTopInSubdomain($domain_details.0.domain_id,'bannerimage')}
                                    {$objCommon->getImageForBannerSlider($smarty.session.page_id,'sliderimage')}
                                    {$objCommon->getBannerStatus_subdomain($smarty.session.page_id)}
