					...
					<div class="themeRightSepOuter">
						<div class="themeRightSep">
							<div class="mainRhtBanner clearfix">
								...
								<div class="mainRhtBannerInner clearfix">
									<div class="paddlefRht">
										...
										<div id="banner">
											<div id="bannerleft">
												<div class="wsite-header" {if $logoimages}style="background-image:url({$SITE_DOMAIN_IMAGES_URL}/{$logoimages}); background-size:100% 100%;"{/if}>
											...
											<div id="bannerright">
												<div class="bannerrightCont">
													<h2 class="mainRhtBannerInnerHead main_headline" style="{if $site_title.0.main_headline_font_style}font-family:{$site_title.0.main_headline_font_style};{/if}{if $site_title.0.main_headline_font_size}font-size:{$site_title.0.main_headline_font_size}px;{/if}{if $site_title.0.main_headline_line_size}line-height:{$site_title.0.main_headline_line_size}px;{/if}">
														<div id="headingContent"  contenteditable="true"  data-ph="Başlığı Güncelle"  class="minhead headlimit contentedit{if $site_title.0.heading_content eq ''} clickheretext contenttext{/if}" onchange="updateHeading('{$smarty.session.domain_id}')"   onblur="updateHeading('{$smarty.session.domain_id}')" onkeyup="updateHeading('{$smarty.session.domain_id}')" >{if $site_title.0.heading_content}{$site_title.0.heading_content}{/if}</div>
													</h2>
													<div id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  class="contentedit {if $site_title.0.heading_description eq ''}clickheretext contenttext{/if}" onchange="updateDescriptionTitle('{$smarty.session.domain_id}')"  onblur="updateDescriptionTitle('{$smarty.session.domain_id}')"   >{if $site_title.0.heading_description}{$site_title.0.heading_description}{/if}</div>
												</div>
											</div>
										</div>
										{/if}
