<?php /* Smarty version 2.6.3, created on 2015-12-17 12:16:04
         compiled from /home/enkolayw/public_html/theme/default/templates/theme2/sourceNew.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', '/home/enkolayw/public_html/theme/default/templates/theme2/sourceNew.tpl', 10, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
/<?php echo $this->_tpl_vars['logo_sub_images']; ?>
		...
		<div class="<?php echo $this->_tpl_vars['themecolorname']; ?>
...
">
			<?php if ($this->_tpl_vars['domain_details']): ?>
				<div class="sourceNewThene">
					<div class="theme2Banner container">
						
                          <div class="logoTopHover clearfix">
	                         <div class="navbar">
                                ...
                                <!--to show  site title start-->
                                    ...
                                    <div class="themewrapperLeft mainPageThmeTitle" style="<?php if ($this->_tpl_vars['domain_details']['0']['site_title_font_style']): ?>font-family:<?php echo $this->_tpl_vars['domain_details']['0']['site_title_font_style']; ?>
...
" alt="home image" width="<?php if ($this->_tpl_vars['domain_details']['0']['logo_width']):  echo $this->_tpl_vars['domain_details']['0']['logo_width'];  else:  endif; ?>" height="<?php if ($this->_tpl_vars['domain_details']['0']['logo_height']):  echo $this->_tpl_vars['domain_details']['0']['logo_height'];  else:  endif; ?>" ></a>
                                ...
                                <!--to show pagename starts-->
                                    ...
                                    <div class="buildNavTabBg themewrapperRight nav-collapse collapse">
                            ...
                            <?php if ($this->_tpl_vars['domain_details']['0']['header_banner'] == 0 && $this->_tpl_vars['domain_details']['0']['header_slider'] == 0): ?>
                                <div class="paddlefRht">
                                    ...
                                    <div id="banner" class="clearfix">
                                        <div id="bannerleft">
                                            <div class="wsite-header" <?php if ($this->_tpl_vars['logo_sub_images']): ?>style="background-image:url(<?php echo $this->_tpl_vars['SITE_DOMAIN_IMAGES_URL']; ?>
/<?php echo $this->_tpl_vars['logo_sub_images']; ?>
);"<?php endif; ?>></div>
...
px;<?php endif; ?>"><?php if ($this->_tpl_vars['domain_details']['0']['heading_content']):  echo $this->_tpl_vars['domain_details']['0']['heading_content'];  endif; ?></div>
                                                <?php endif; ?>
                                                <p><?php if ($this->_tpl_vars['domain_details']['0']['heading_description']):  echo $this->_tpl_vars['domain_details']['0']['heading_description'];  endif; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <?php if ($this->_tpl_vars['domain_details']['0']['header_banner']): ?>
                                <div class="paddlefRht">
                                    ...
                                    <?php echo $this->_tpl_vars['objCommon']->getImageForBannerSlider($_SESSION['page_id'],'sliderimage'); ?>
