...
" class="nomargin addeditTop addeditbuttonForm form-horizontal SlideUploadForm" method="post" enctype="multipart/form-data" action='ajaxGalleryImageUpload.php'>
...
" class="inputfile" size="1" onchange="galleryImageUpdatingProcess('<?php echo $_REQUEST['page_list_id']; ?>
');" multiple="" />
							Yeni Resim Yükle
						</div>
...
" />
    						<a class="galleryimage" onclick="deleteGalImg('<?php echo $_SESSION['domain_id']; ?>
