<?php /* Smarty version 2.6.3, created on 2015-12-10 20:42:11
         compiled from /home/enkolayw/public_html/theme/default/templates/theme2/buildpagesList.tpl */ ?>
...
<div class="clearfix <?php echo $_SESSION['themecolorname']; ?>
 <?php if ($_SESSION['themename'] == 'theme9'): ?>theme9<?php endif; ?>" id="theme_background" style="<?php if ($this->_tpl_vars['banner_config']):  if ($this->_tpl_vars['logoimages'] && $this->_tpl_vars['default_switch'] == 'N'): ?>background:url(<?php echo $this->_tpl_vars['SITE_DOMAIN_IMAGES_URL']; ?>
							...
							<div class="mainRhtBanner clearfix">
								...
								<div class="mainRhtBannerInnerBanner clr">
									<div class="paddlefRht">
										...
										<div id="banner">
											<div id="bannerleft">
												<div class="wsite-header" <?php if ($this->_tpl_vars['logoimages']): ?>style="background-image:url(<?php echo $this->_tpl_vars['SITE_DOMAIN_IMAGES_URL']; ?>
/<?php echo $this->_tpl_vars['logoimages']; ?>
...
px;<?php endif; ?>">
														<div id="headingContent"  contenteditable="true"  data-ph="Başlığı Güncelle"  class="minhead headlimit contentedit<?php if ($this->_tpl_vars['site_title']['0']['heading_content'] == ''): ?> clickheretext contenttext<?php endif; ?>" onblur="updateHeading('<?php echo $_SESSION['domain_id']; ?>
