<?php /* Smarty version 2.6.3, created on 2015-12-19 10:54:57
         compiled from /home/enkolayw/public_html/theme/default/templates/theme3/buildpagesList.tpl */ ?>
...
<div class="<?php echo $_SESSION['themename']; ?>
 clearfix <?php echo $_SESSION['themecolorname']; ?>
...
')" onkeyup="updateHeading('<?php echo $_SESSION['domain_id']; ?>
')" ><?php if ($this->_tpl_vars['site_title']['0']['heading_content']):  echo $this->_tpl_vars['site_title']['0']['heading_content'];  endif; ?></div>
													</h2>
													<div id="headingdescription" contenteditable="true"  data-ph="Açıklamayı Güncelle"  class="contentedit <?php if ($this->_tpl_vars['site_title']['0']['heading_description'] == ''): ?>clickheretext contenttext<?php endif; ?>" onchange="updateDescriptionTitle('<?php echo $_SESSION['domain_id']; ?>
